...
```
The corrleation coefficent between x and y is r=-0.0629, meaning that there is no linear relationship between the x and y variables in the 'dino' dataset. The r for star is almost identical as the r for dino, indicating the star dataset does not have a stronger linear relationship.
